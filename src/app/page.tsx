    ...
    <div className="p-4 w-full h-screen">
      ...
      <div className="flex w-full flex-col h-full">
        ...
        {products.length == 0 && (
          <div
            onClick={() => setIsOpen(true)}
            className="flex-1 pb-32 cursor-pointer p-4 rounded-lg flex flex-col items-center justify-center self-center text-center gap-8 border border-transparent hover:border-[#039ADC] transition-all ease-in-out duration-250"
          >
